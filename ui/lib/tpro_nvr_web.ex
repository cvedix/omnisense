  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: TProNVRWeb.Layouts]

      import Plug.Conn
      import TProNVRWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: TProNVRWeb.Endpoint,
        router: TProNVRWeb.Router,
        statics: TProNVRWeb.static_paths()
    end
  end
