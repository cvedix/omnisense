defmodule TProNVRWeb.CoreComponents do
  @moduledoc """
  ...
  """
  use Gettext, backend: TProNVRWeb.Gettext
  use Phoenix.Component

  alias TProNVRWeb.Components
  alias Phoenix.HTML
  ...
  def modal(assigns) do
    ...
    >
      ...
      <div
        class={["fixed inset-0 overflow-y-auto", @class || "bg-green-900"]}
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-lg p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-lg bg-green-800 p-2 shadow-lg ring-1 transition shadow dark:bg-black"
            >
  ...
  def modal2(assigns) do
    ...
    >
      <div class="relative p-4 w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-black rounded-lg shadow-sm dark:bg-black">
          <!-- Modal header -->
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-green-700 border-green-700">
            <h3 class="text-xl font-semibold text-white dark:text-white">
              {render_slot(@header)}
            </h3>
            <button
              type="button"
              class="end-2.5 text-white/80 bg-transparent hover:bg-green-900 hover:text-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-green-800 dark:hover:text-white"
              phx-click={JS.exec("data-cancel", to: "##{@id}")}
            >
              <.icon name="hero-x-mark-solid dark:bg-white" class="h-5 w-5" />
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info &&
          "text-sm text-green-800 rounded-lg bg-blue-50 dark:bg-black dark:text-green-400",
        @kind == :error &&
          "text-sm text-red-800 rounded-lg bg-red-50 dark:bg-black dark:text-red-400"
      ]}
      {@rest}
    >
      <p
        :if={@title}
        class="flex items-center gap-1.5 text-sm font-semibold leading-6 dark:bg-black"
      >
    ...
    <div phx-feedback-for={@name}>
      <label class="inline-flex items-center mb-5 cursor-pointer">
        ...
        <input
          ...
          {@rest}
        />
        <div class="relative w-11 h-6 bg-green-900 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 rounded-full peer dark:bg-black peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-black after:border-green-700 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-green-700 peer-checked:bg-green-600 dark:peer-checked:bg-green-600">
        </div>
      </label>
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-white">
        ...
        <input
          ...
          checked={@checked}
          class={[
            "rounded text-white border-green-700 rounded bg-black focus:ring-3 focus:ring-green-300",
            "dark:bg-black dark:border-green-700 dark:focus:ring-green-600",
            "dark:ring-offset-green-900 dark:focus:ring-offset-green-900"
          ]}
          {@rest}
        />
        {@label}
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600 dark:text-white">
        <input
          ...
          name={@name}
          class={[
            "rounded text-zinc-900 border-green-700 rounded bg-black focus:ring-3 focus:ring-green-300",
            "dark:bg-black dark:border-green-700 dark:focus:ring-green-600",
            "dark:ring-offset-green-900 dark:focus:ring-offset-green-900"
          ]}
          value={@value}
  ...
  def input(%{type: "radio"} = assigns) do
    ~H"""
    <div phx-feedback-for={@name}>
      <ul class="border border-green-700 rounded-lg dark:border-green-700">
        <li
          :for={option <- @options}
          class="p-2 w-full border-b border-green-700 rounded-t-lg dark:border-green-700"
        >
      ...
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600 dark:text-white">
        <input
          ...
          class={[
            "rounded text-zinc-900 border-green-700 rounded bg-black focus:ring-3 focus:ring-green-300",
            "dark:bg-black dark:border-green-700 dark:focus:ring-green-600",
            "dark:ring-offset-green-900 dark:focus:ring-offset-green-900 w-60"
          ]}
          value={@value}
          {@rest}
        />
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        ...
        name={@name}
        class={[
          "mt-1 block w-full rounded-md border border-green-700 bg-black shadow-sm focus:border-zinc-400 focus:ring-0 text-sm",
          "dark:bg-black dark:border-green-700 dark:placeholder-white/50 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500"
        ]}
        multiple={@multiple}
        {@rest}
      >
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        class={[
          ...
          "min-h-[6rem] border-zinc-300 focus:border-zinc-400 dark:bg-black",
          "dark:border-green-700 dark:placeholder-white/50 dark:text-white",
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-1 block w-full rounded-lg focus:ring-0 sm:text-sm sm:leading-6",
          "phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400",
          "bg-green-900 border-green-700 text-white placeholder-white/50",
  ...
  def label(assigns) do
    ...
    <label
      for={@for}
      class={["block text-sm font-semibold leading-6 text-white", @class]}
    >
      {render_slot(@inner_block)}
    </label>
    """
      ...
      <ul :if={@meta.total_pages > 0} class="flex items-center -space-x-px h-8 text-sm">
        <li>
          <a
            ...
            class={
              [
                "flex items-center justify-center px-3 h-8 ml-0 leading-tight bg-black border border-green-700 rounded-l-lg"
              ] ++
                if not @meta.has_previous_page?,
                  do: ["pointer-events-none text-white"],
                  else: [
                    "text-white/60 hover:bg-green-900 hover:text-white dark:bg-black dark:border-green-800 dark:text-white/80 dark:hover:bg-black dark:hover:text-white"
                  ]
            }
          >
        ...
        <li :if={@meta.total_pages > 6 && @meta.current_page > 4}>
          <span class="px-3 h-8 text-white/60">...</span>
        </li>
        <li
        ...
        <li>
          <a
            ...
            class={
              [
                "flex items-center justify-center px-3 h-8 leading-tight border border-green-700 bg-black rounded-r-lg"
              ] ++
  ...
  defp pagination_link(assigns) do
    ...
    <.link
      ...
      class={
        [
          "flex items-center justify-center px-3 h-8 leading-tight border dark:border-green-800"
        ] ++
          if @current_page == @page,
            do: [
              "z-10 pointer-events-none text-green-600 bg-blue-50 border-green-300 hover:bg-green-100 hover:text-green-700 dark:bg-black dark:text-white"
            ],
            else: [
              "text-white/60 bg-black border-green-700 hover:bg-green-900 hover:text-white dark:bg-black dark:text-white/80 dark:hover:bg-black dark:hover:text-white"
            ]
      }
    >
      {@page}
  ...
  def separator(assigns) do
    ~H"""
    <hr class={["h-px my-8 bg-green-900 border-0 dark:bg-black", @class]} />
    """
  end
  ...
  def three_dot(assigns) do
    ...
    <button
      ...
      class="text-sm ml-3 bg-green-900 hover:bg-green-900 text-zinc-900 dark:bg-black dark:text-white/80"
      {@rest}
    >
      <.icon name="hero-ellipsis-vertical" class="w-6 h-6 text-green-500" />
    </button>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TProNVRWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TProNVRWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def copy_button(assigns) do
    ~H"""
    <button
      class="bg-black hover:bg-slate-600 text-white font-bold py-2 px-3 rounded-md"
  ...
  def code_snippet(assigns) do
    ...
    <div class="relative h-full">
      <div
        ...
        data-lang={@lang}
        class="relative bg-green-900 dark:bg-black rounded-md overflow-x-auto border border-white dark:bg-black dark:border-green-800"
      >
        <pre class="text-sm text-white/80 p-5"><code><%= @code %></code></pre>
      </div>
