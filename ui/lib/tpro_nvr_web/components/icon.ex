defmodule TProNVRWeb.Components.Icon do
  @moduledoc false
  ...
  ## Examples
      ...
      <.icon name="svg-github" class="w-6 h-6 text-green-500" />
  """
  ...
  def icon(%{name: "svg-github"} = assigns) do
    ...
    <svg
      ...
      fill="currentColor"
      class={["w-6 h-6 dark:text-white/80", @class]}
      viewBox="0 0 640 640"
      aria-hidden="true"
    >
  ...
  def icon(%{name: "network"} = assigns) do
    ...
    <svg
      ...
      class={["lucide lucide-network text-green-600", @class]}
    >
