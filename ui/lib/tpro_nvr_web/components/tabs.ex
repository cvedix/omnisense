defmodule TProNVRWeb.Components.Tabs do
  @moduledoc false
  ...
  attr :active_class, :string,
    default:
      "bg-green-600 dark:bg-green-500 text-green-600 border-green-600 dark:text-green-500 dark:border-green-500"

  attr :inactive_class, :string,
    default: "text-white text-white dark:text-white hover:bg-green-700 dark:hover:bg-black"
  ...
  def render(assigns) do
    ...
    <div id={@id} class={@class}>
      <div class="border-b border-green-700 dark:border-green-800">
        <ul class="flex flex-wrap -mb-px text-center text-white/60 dark:text-white/80">
          <%= for tab <- @tab do %>
            <li
              id={"tab-" <> tab.id}
              class="me-2"
