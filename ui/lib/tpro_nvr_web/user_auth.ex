defmodule TProNVRWeb.UserAuth do
  @moduledoc false

  use TProNVRWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 15
  @remember_me_cookie "_cvr_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      TProNVRWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule TProNVRWeb.PageLive do
        use TProNVRWeb, :live_view

        on_mount {TProNVRWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TProNVRWeb.UserAuth, :ensure_authenticated}] do
