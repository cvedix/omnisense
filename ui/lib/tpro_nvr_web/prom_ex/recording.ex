defmodule TProNVRWeb.PromEx.Recording do
  @moduledoc false
  ...
  @recording_event [:tpro_nvr, :recordings, :stop]

  @impl true
  def event_metrics(_opts) do
    Event.build(
      :tpro_nvr_recordings_event_metrics,
      [
        counter("cvr.recording.total",
        ...
        distribution("cvr.recording.duration.milliseconds",
          event_name: @recording_event,
        ...
        distribution("cvr.recording.size.bytes",
          event_name: @recording_event,
          measurement: :size,
