defmodule TProNVRWeb.PromEx.Device do
  @moduledoc false
  ...
  @device_status_event [:tpro_nvr, :device, :state]
  @camera_info_event [:tpro_nvr, :camera, :info]
  @camera_stream_info_event [:tpro_nvr, :camera, :stream, :info]
