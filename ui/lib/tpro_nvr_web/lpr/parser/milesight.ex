defmodule TProNVRWeb.LPR.Parser.Milesight do
  @moduledoc """
  An implementation of `TProNVRWeb.LPR.Parser` behaviour that parse milesight LPR event
  """

  @behaviour TProNVRWeb.LPR.Parser
