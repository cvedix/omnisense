defmodule TProNVRWeb.OnvifDiscoveryLive do
      ...
      <div :if={@selected_device} class="w-3/4 flex flex-col space-y-2 mr-5">
        ...
        <div class="grid grid-cols-4 content-center rounded-lg bg-black dark:border-green-700 dark:bg-black dark:text-white p-1">
          ...
          <div class={["flex justify-center", selected_tab("network", @selected_device.tab)]}>
            ...
            >
              <.icon name="network" class="w-4 h-4 mr-1 text-white inline" />Network
            </span>
          </div>
        ...
        >
          ...
          <div class="space-y-2 p-5 pt-0 text-sm">
            <div class="flex justify-between">
              <span class="text-white/60">Manufacturer:</span>
            ...
            <div class="flex justify-between">
              <span class="text-white/60">Hardware ID:</span>
        ...
        >
          ...
          <div class="space-y-2 p-5 pt-0 text-sm">
            <div class="grid grid-cols-2 gap-x-6 gap-y-2">
              ...
              <div class="flex justify-between">
                <span class="text-white/60">MAC Address:</span>
                <span class="font-mono">{@selected_device.network_interface.hw_address}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-white/60">DHCP:</span>
        ...
        >
          ...
          <div class="space-y-2 p-5 pt-0 text-sm">
            <div class="grid grid-cols-2 gap-x-6 gap-y-2">
              ...
              <div class="flex justify-between">
                <span class="text-white/60">NTP Enabled</span>
                <.tag>{yes_no(@selected_device.ntp)}</.tag>
              </div>
              <div class="flex justify-between">
                <span class="text-white/60">Dayligth Saving</span>
                <.tag>
                  {yes_no(@selected_device.device.system_date_time.daylight_savings)}
                </.tag>
              </div>
              <div class="flex justify-between">
                <span class="text-white/60">NTP Server</span>
  ...
  defp selected_tab(tab, tab), do: ["rounded-sm", "bg-green-800", "dark:bg-black"]
