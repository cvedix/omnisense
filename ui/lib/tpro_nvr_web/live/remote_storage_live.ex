defmodule TProNVRWeb.RemoteStorageLive do
  @moduledoc false

  use TProNVRWeb, :live_view

  alias TProNVR.RemoteStorage
  alias TProNVR.RemoteStorages

  def render(assigns) do
    ~H"""
    <div class="grow max-w-2xl mx-auto e-py-10">
      <div class="px-6 lg:px-8 bg-green-800 dark:bg-black">
        <h3
          :if={@remote_storage.id == nil}
          class="mb-4 text-xl text-center font-medium text-white dark:text-white"
        >
        ...
        >
          ...
          <p class="text-xl font-medium mb-4 text-white dark:text-white">
            Storage Config
          </p>
