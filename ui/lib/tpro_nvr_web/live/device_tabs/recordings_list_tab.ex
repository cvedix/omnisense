defmodule TProNVRWeb.DeviceTabs.RecordingsListTab do
  @moduledoc false
  ...
  import TProNVRWeb.RecordingListLive, only: [recording_details_popover: 1]

  alias TProNVR.Recordings
  alias TProNVRWeb.RecordingListLive
  ...
  def render(assigns) do
    ~H"""
    <div>
      <div class="text-center text-white/60 dark:text-white/80" id="recordings-tab">
        <.filter_form
          meta={@meta}
        ...
        <div class="fixed bottom-0  right-10 w-full">
          <div class="bg-green-800 dark:bg-black">
            <div class="pb-5">
