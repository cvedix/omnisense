defmodule TProNVR.Model.Recording do
  @moduledoc false
  ...
  @derive {Flop.Schema,
           ...
           sortable: [:id, :start_date, :end_date, :device_name, :device_id],
           default_order: %{
             order_by: [:id],
  ...
  schema "recordings" do
    ...
    belongs_to :run, TProNVR.Model.Run, type: :integer
  end
  ...
  def get_query(query \\ __MODULE__, device_id, name) do
    from(r in query, where: r.device_id == ^device_id and r.filename == ^name, limit: 1)
  end
