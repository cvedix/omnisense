defmodule TProNVR.Devices.SnapshotUploader do
  @moduledoc false
  ...
  alias TProNVR.{Devices, RemoteStorages}
  alias TProNVR.Model.Device
  alias TProNVR.RemoteStorage
  alias TProNVR.RemoteStorages.Store
  ...
  defp fetch_and_upload_snapshot(remote_storage, device, utc_now, opts) do
    Task.Supervisor.async_nolink(TProNVR.TaskSupervisor, fn ->
