defmodule TProNVR.Devices do
  ...
  alias Ecto.Multi
  alias TProNVR.Devices.Cameras.HttpClient.{Axis, Hik, Milesight}
  alias TProNVR.{HTTP, Pipelines, Repo}
  ...
  @spec create_device_directories(TProNVR.Model.Device.t()) :: :ok
