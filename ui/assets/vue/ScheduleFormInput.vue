    ...
    <div class="flex gap-4 mt-1">
      ...
      <label class="inline-flex items-center">
        ...
        <input
          type="radio"
          value="default"
          class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-green-900 dark:border-green-700"
