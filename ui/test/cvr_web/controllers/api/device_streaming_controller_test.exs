defmodule CVRWeb.API.DeviceStreamingControllerTest do
  @moduledoc false

  use CVRWeb.ConnCase

  import CVR.{AccountsFixtures, DevicesFixtures, RecordingsFixtures}
  ...
  describe "GET /api/devices/:device_id/hls/index.m3u8" do
    setup %{device: device} do
      Path.join(CVR.Utils.hls_dir(device.id), "live")
      |> tap(&File.mkdir_p!/1)
