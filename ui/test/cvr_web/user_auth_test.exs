defmodule CVRWeb.UserAuthTest do
  @moduledoc false

  use CVRWeb.ConnCase

  import CVR.AccountsFixtures

  alias CVR.Accounts
  alias CVRWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CVRWeb.Endpoint.config(:secret_key_base))
      |> fetch_query_params()
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CVRWeb.Endpoint.subscribe(live_socket_id)
