defmodule CVR.RemoteStorages.Store.HTTPTest do
  @moduledoc false

  use CVR.DataCase

  import CVR.{DevicesFixtures, RecordingsFixtures}

  alias CVR.RemoteStorages.Store.HTTP
  ...
  describe "save recording" do
    ...
    test "recording is sent as a multipart", %{bypass: bypass, device: device} do
      ...
      recording_path = CVR.Recordings.recording_path(device, recording)
