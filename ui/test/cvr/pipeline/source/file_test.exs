defmodule CVR.Pipeline.Source.FileTest do
  @moduledoc false

  use CVR.DataCase, async: true

  import CVR.DevicesFixtures

  alias CVR.Pipeline.Source
  ...
  test "init file source", %{device: device} do
    ...
    assert %CVR.Pipeline.Track{encoding: :h264, type: :video} = media_track
  end
